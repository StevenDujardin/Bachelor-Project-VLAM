...
export const Card: FC<CardProps> = ({
  ...
  return (
    <div
      className="flex flex-row lg:flex-row lg:w-80 h-fit mx-4 rounded-2xl overflow-hidden object-cover shadow-xl transition duration-300 hover:shadow-2xl hover:translate-y-2 hover:scale-105"
